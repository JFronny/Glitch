...
namespace GlitchPayloads
{
    ...
    public static class Russian
    {
        ...
        {
            PostMessage(0xffff, 0x0050, IntPtr.Zero, LoadKeyboardLayout(new CultureInfo("ru-ru").LCID.ToString("x8"), 1));
        }
        ...
        static IYandexTranslator translator = Yandex.Translator.Yandex.Translator(api => api.ApiKey("trnsl.1.1.20200118T180605Z.654f2ec649458c36.107c6ad38dc02937f25e660aa1f8f4097d6561a8").Format(ApiDataFormat.Json));
